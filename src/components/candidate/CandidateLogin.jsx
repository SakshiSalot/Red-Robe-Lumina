...
const CandidateLogin = ({ onLogin, onSwitchToJoin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // This account must be a candidate to use the candidate area.
            if (data.role !== 'CANDIDATE') {
                AuthService.logout();
                setIsLoading(false);
                setError('This is a recruiter account. Please use the Recruiter login, or Join as a candidate with a different email.');
                return;
            }
